// CodeMirrorの自動補完機能で使用されるデフォルトの補完項目を定義します。
const defaultCompletions = [
    { label: "move", type: "function", info: "スプライトを移動します (例: move(10);)" },
    { label: "turnRight", type: "function", info: "スプライトを右に回転します (例: turnRight(15);)" },
    { label: "turnLeft", type: "function", info: "スプライトを左に回転します (例: turnLeft(15);)" },
    { label: "say", type: "function", info: "スプライトが言います (例: say('Hello!');)" },
    { label: "think", type: "function", info: "スプライトが考えます (例: think('Hmm...');)" },
    { label: "onGreenFlagClicked", type: "function", info: "緑の旗がクリックされたときに実行 (例: onGreenFlagClicked() { ... });)" },
    ...
    { label: "wait", type: "function", info: "待つ (例: wait(1);)" },
    { label: "broadcast", type: "function", info: "メッセージを送る (例: broadcast('message1');)" },
    { label: "onReceive", type: "function", info: "メッセージを受け取ったとき (例: onReceive('message1') { ... });)" },
    ...
    { label: "xPosition", type: "variable", info: "X座標 (レポーター)" },
    { label: "yPosition", type: "variable", info: "Y座標 (レポーター)" },
    { label: "direction", type: "variable", info: "向き (レポーター)" },
    { label: "costumeName", type: "variable", info: "コスチューム名 (レポーター)" },
    { label: "backdropName", type: "variable", info: "背景名 (レポーター)" },
];

export default defaultCompletions;
