...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "file", "symbols": ["padding"], "postprocess": emptyList},
    {"name": "file", "symbols": ["padding", "scripts", "padding"], "postprocess": select(1)},
    ...
    {"name": "padding", "symbols": ["padding$ebnf$1"], "postprocess": ignore},
    {"name": "scripts", "symbols": ["scripts", "scriptSep", "script"], "postprocess": push2},
    {"name": "scripts", "symbols": ["script"], "postprocess": box},
    {"name": "scriptSep", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL), "_", (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": ignore},
    {"name": "scriptSep", "symbols": ["scriptSep", "_", (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": ignore},
    {"name": "script", "symbols": ["script", (lexer.has("NL") ? {type: "NL"} : NL), "line"], "postprocess": push2},
    {"name": "script", "symbols": ["line"], "postprocess": box},
    {"name": "line", "symbols": ["_", "thing", "_"], "postprocess": select(1)},
    ...
    {"name": "block", "symbols": ["hat"], "postprocess": id},
    {"name": "hat", "symbols": [{"literal":"when"}, "__", "_greenFlag", "__", {"literal":"clicked"}], "postprocess": block("whenGreenFlag")},
    {"name": "hat", "symbols": [{"literal":"when"}, "__", "m_key", "__", {"literal":"key"}, "__", {"literal":"pressed"}], "postprocess": block("whenKeyPressed", 2)},
    {"name": "hat", "symbols": [{"literal":"when"}, "__", {"literal":"this"}, "__", {"literal":"sprite"}, "__", {"literal":"clicked"}], "postprocess": block("whenClicked")},
    {"name": "hat", "symbols": [{"literal":"when"}, "__", {"literal":"backdrop"}, "__", {"literal":"switches"}, "__", {"literal":"to"}, "__", "m_backdrop"], "postprocess": block("whenSceneStarts", 8)},
    {"name": "hat", "symbols": [{"literal":"when"}, "__", "m_triggerSensor", "__", {"literal":">"}, "__", "n"], "postprocess": block("whenSensorGreaterThan", 2, 6)},
    {"name": "hat", "symbols": [{"literal":"when"}, "__", {"literal":"I"}, "__", {"literal":"receive"}, "__", "m_broadcast"], "postprocess": block("whenIReceive", 6)},
    {"name": "hat", "symbols": [{"literal":"when"}, "__", {"literal":"I"}, "__", {"literal":"start"}, "__", {"literal":"as"}, "__", {"literal":"a"}, "__", {"literal":"clone"}], "postprocess": block("whenCloned")},
    {"name": "mouth", "symbols": [{"literal":"{"}, "_", (lexer.has("NL") ? {type: "NL"} : NL), "script", (lexer.has("NL") ? {type: "NL"} : NL), "_", {"literal":"}"}], "postprocess": select(3)},
    {"name": "mouth", "symbols": [{"literal":"{"}, "_", (lexer.has("NL") ? {type: "NL"} : NL), "_", {"literal":"}"}], "postprocess": literal(null)},
    {"name": "elsemouth", "symbols": [{"literal":"{"}, "_", (lexer.has("NL") ? {type: "NL"} : NL), "script", (lexer.has("NL") ? {type: "NL"} : NL), "_", {"literal":"}"}, "else"], "postprocess": select(3)},
    {"name": "elsemouth", "symbols": [{"literal":"{"}, "_", (lexer.has("NL") ? {type: "NL"} : NL), "_", {"literal":"}"}, "else"], "postprocess": literal(null)},
    {"name": "block", "symbols": [{"literal":"repeat"}, "__", "n", "_", "mouth"], "postprocess": block("doRepeat", 2, 4)},
    {"name": "block", "symbols": [{"literal":"if"}, "__", "b", "__", {"literal":"then"}, "_", "mouth"], "postprocess": block("doIf", 2, 6)},
    {"name": "block", "symbols": [{"literal":"if"}, "__", "b", "__", {"literal":"then"}, "_", "elsemouth", "mouth"], "postprocess": block("doIfElse", 2, 6, 7)},
    {"name": "block", "symbols": [{"literal":"forever"}, "_", "mouth"], "postprocess": block("doForever", 2)},
    {"name": "block", "symbols": [{"literal":"repeat"}, "__", {"literal":"until"}, "__", "b", "_", "mouth"], "postprocess": block("doUntil", 4, 6)},
    {"name": "block", "symbols": [{"literal":"move"}, "__", "n", "__", {"literal":"steps"}], "postprocess": block("forward:", 2)},
    {"name": "block", "symbols": [{"literal":"turn"}, "__", "_turnRight", "__", "n", "__", {"literal":"degrees"}], "postprocess": block("turnRight:", 4)},
    {"name": "block", "symbols": [{"literal":"turn"}, "__", "_turnLeft", "__", "n", "__", {"literal":"degrees"}], "postprocess": block("turnLeft:", 4)},
    ...
    {"name": "else", "symbols": ["_", {"literal":"else"}, "_"], "postprocess": ignore},
    {"name": "ellips", "symbols": ["_", {"literal":"..."}, "_"], "postprocess": ignore},
